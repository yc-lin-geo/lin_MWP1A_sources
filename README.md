...
## File Descriptions
* **[MWP-1A_sources_inversion.ipynb](./MWP-1A_sources_inversion.ipynb)** - Notebook creating the Last Interglacial emulator optimized+conditioned on the training data
* **[MWP-1A_sources_inversion.ipynb](./MWP-1A sources inversion.ipynb)** -  A notebook contains the code used for MWP-1A inversion
